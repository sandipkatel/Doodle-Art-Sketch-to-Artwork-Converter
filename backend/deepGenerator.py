...
class Generator(nn.Module):
    ...
    def __init__(self, in_channels=3, features=64):
        ...
        # Decoder
        self.up1 = DeepBlock(features * 8, features * 8, down=False, use_dropout=True)
        self.up2 = DeepBlock(features * 8 * 2, features * 8, down=False, use_dropout=True)
        self.up3 = DeepBlock(features * 8 * 2, features * 8, down=False, use_dropout=True)
