...
def pix_translate(input_file, output_file, model_dir='models/pix2pix'):
    with open(input_file, "rb") as f:
        ...
        # im = im.resize((256, 256), Image.ANTIALIAS)   // Updated here
    ...
    # with tf.Session() as sess:  updated here
    with tf.Session() as sess:
        import os
        print(os.path.abspath(model_dir + "/export.meta"))
        print(os.path.exists(model_dir + "/export.meta"))
        saver = tf.train.import_meta_graph(model_dir + "/export.meta")  # updated here
        tf.disable_v2_behavior()

        # saver = tf.train.import_meta_graph(mod1el_dir + "/export.meta")
