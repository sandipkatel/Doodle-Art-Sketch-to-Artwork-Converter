...
# def pad_reflect(x, padding=1): # updated here
#     return tf.pad(
...
def wct_tf(content, style, alpha, eps=1e-8):
    ...
    # content_t = tf.transpose(tf.squeeze(content), (2, 0, 1)) # Updated here
    # style_t = tf.transpose(tf.squeeze(style), (2, 0, 1)) # updated here
